...
TITLE = "CIFAR10 (cnn)"
OUTPUT_DIR = "output/cnn_cifar"

TARGET_VALIDATION_ACC = 0.6
...
def get_task_metadata():
    ...
    return {
        ...
        "description": "Fit a convolutional neural network on Cifar10 using a ADAM."
    }
...
def make_dataloaders(batch_size=32, device=None):
    ...
    train_dataset = torchvision.datasets.CIFAR10(".data/cifar", True, download=True, transform=transform)
    val_dataset = torchvision.datasets.CIFAR10(".data/cifar", False, download=True, transform=transform)
